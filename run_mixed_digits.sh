...
SHORT_PAUSE_OUTPUT_DIR="${BASE_OUTPUT_DIR}/mixed_digits_short_pause/audio"
SHORT_PAUSE_TSV="${TSV_DIR}/mixed_digits_short_pause.tsv"
SHORT_PAUSE_MIN=0
SHORT_PAUSE_MAX=0

# Long pause configuration
LONG_PAUSE_OUTPUT_DIR="${BASE_OUTPUT_DIR}/mixed_digits_long_pause/audio"
LONG_PAUSE_TSV="${TSV_DIR}/mixed_digits_long_pause.tsv"
LONG_PAUSE_MIN=4
LONG_PAUSE_MAX=8
